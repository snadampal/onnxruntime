...
class GraphExecutionManager(GraphExecutionInterface):
    def __init__(self, module, debug_options: DebugOptions, fallback_manager: _FallbackManager):
        ...
        self._enable_embedding_sparsity_optimization = (
            self._enable_compute_optimizer
            and ortmodule._defined_from_envvar("ORTMODULE_ENABLE_EMBEDDING_SPARSITY_OPT", 0, warn=True) == 1
        )
    ...
    def _get_graph_transformer_config(self):
        ...
        graph_transformer_config.enable_embedding_sparsity_optimization = self._enable_embedding_sparsity_optimization
